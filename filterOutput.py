...
def acceptance_test(data):
    ...
    inb = {'[Basic]SeveralRecipients in TO': "\"delivery_state\":\"delivered\"",
           ...
           '[Inbound](Default) Core Anti-Malware"': 'Score is 327',
           ...
           '[Custom]Executive Tracking"': '[EXACT]',
    ...
    outm = {'[Acceptance][outbound][Basic]SeveralRecipients in TO': '"delivery_state":"delivered"',
            ...
            '[Acceptance][outbound](Default) Core Anti-Malware"': 'Score is 218',
            ...
            '[Acceptance][outbound][Custom]Virus': '"final_rule_name":"Virus Test"',
            '[Acceptance][outbound][Custom][secure] SecureMail': '"final_action_name":"Secure Deliver"',
            ...
            '[Acceptance][outbound]Customers - Social Security Outbound Attachment': '"final_rule_name":"Customers - Social Security Outbound Attachment"',
